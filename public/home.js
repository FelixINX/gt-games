      ...
      : _c(
          ...
          [
            _c(
              ...
              { attrs: { color: "white" } },
              [
                _c("v-card-title", [_vm._v("Bienvenue dans GT Games!")]),
                _vm._v(" "),
                _c("v-card-text", [
                  _vm._v(
                    "\n                GT Games est un site web de jeu créé par des étudiants de l'ITHQ pour les étudiants de l'ITHQ."
                  ),
                  _c("br"),
                  _vm._v(" "),
                  _c("b", [
                    _vm._v("Un compte monithq.ca est requis pour se connecter.")
                  ])
                ]),
                _vm._v(" "),
                _c(
                  ...
                  [
                    _c(
                      "v-btn",
                      { attrs: { color: "accent", href: "/login/google" } },
                      [
                        _c("v-icon", { attrs: { left: "" } }, [
                          _vm._v("mdi-google")
                        ]),
                    ...
                    _c(
                      "svg",
                      {
                        staticClass: "game-preview game-1",
                        attrs: { height: "100", width: "100" }
                      },
                      [
                        _c("circle", {
                    ...
                    _c(
                      "svg",
                      {
                        staticClass: "game-preview game-2",
                        attrs: { height: "100", width: "100" }
                      },
                      [
                        _c("circle", {
